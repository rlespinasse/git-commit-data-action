...
{
  echo "GIT_COMMIT_AUTHOR=$(git_log_format "$AUTHOR_FORMAT" "HEAD")"
  echo "GIT_COMMIT_AUTHOR_NAME=$(git_log_format "$AUTHOR_NAME_FORMAT" "HEAD")"
  echo "GIT_COMMIT_AUTHOR_EMAIL=$(git_log_format "$AUTHOR_EMAIL_FORMAT" "HEAD")"
